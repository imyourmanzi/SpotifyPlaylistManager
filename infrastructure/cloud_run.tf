...
resource "google_cloud_run_v2_service" "staging_server" {
  provider = google-beta
...
resource "google_cloud_run_v2_service_iam_policy" "staging_server_access" {
  location = google_cloud_run_v2_service.staging_server.location
  name     = google_cloud_run_v2_service.staging_server.name
